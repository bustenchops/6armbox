...
#setup GPIOs and LEDstate
GPIO.setup(Cam1pin,GPIO.out,initial = 0)
GPIO.setup(Cam2pin,GPIO.out,initial = 0)
GPIO.setup(Cam3pin,GPIO.out,initial = 0)
GPIO.setup(Cam4pin,GPIO.out,initial = 0)
GPIO.setup(Cam5pin,GPIO.out,initial = 0)
GPIO.setup(Cam6pin,GPIO.out,initial = 0)
...
def signalsend(zonenumber)
    if zonenumber == 1:
        ...
        GPIO.output(Cam3pin, 0)
        GPIO.output(Cam4pin, 0)
        GPIO.output(Cam5pin, 0)
        GPIO.output(Cam6pin, 0)
    if zonenumber == 2:
        GPIO.output(Cam1pin, 0)
        GPIO.output(Cam2pin, 1)
        GPIO.output(Cam3pin, 0)
        GPIO.output(Cam4pin, 0)
        GPIO.output(Cam5pin, 0)
        GPIO.output(Cam6pin, 0)
    ...
    if zonenumber == 6:
        ...
        GPIO.output(Cam4pin, 0)
        GPIO.output(Cam5pin, 0)
        GPIO.output(Cam6pin, 1)
    else:
        print("what zone cant send")
...
def main():
    ...
    while True:
        ...
        if cv2.waitKey(1) & 0xFF == ord(' '):
            GPIO.output(LEDpin,1) #turn on LED at start of tracking and will turn of and on every 5 seconds
            LEDstate = 1
            break
    ...
    while True:
        ...
        dtLED = current_time - ledflashtime
