...
def main():
    ...
    writer = cv2.VideoWriter('output_mosse_border.avi', fourcc, 30.0, (WIDTH, HEIGHT), True)
    ...
    while True:
        ...
        cv2.rectangle(frame, (BORDER, BORDER), (WIDTH - BORDER, HEIGHT - BORDER), (0, 255, 255), 2)
        ...
        if not success:
            ...
            if new_bbox:
                ...
                writer.write(frame)
                cv2.imshow("MOSSE Tracking with Border", frame)
